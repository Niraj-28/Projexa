            ...
            {!success ? (
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex flex-col space-y-1">
                  <label className="text-[11px] font-medium text-[#01161E]">Email Address</label>
                  <input
                    type="email"
              ...
              <div className="space-y-4 text-center py-4 bg-[#F1F5F9]/30 border border-[#E2E8F0] p-5 rounded-2xl">
                ...
                <div className="space-y-1">
                  <h3 className="text-sm font-medium text-[#01161E] font-heading">Check Your Inbox</h3>
                  <p className="text-[11px] text-[#598392] font-light leading-relaxed">
                    Instructions sent to <strong className="text-[#01161E] font-mono">{email}</strong>. Use the link to reset your password.
                  </p>
                </div>
                <button
