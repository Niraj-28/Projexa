  ...
  return (
    <div className="min-h-screen bg-[#131313] grid grid-cols-1 lg:grid-cols-12 font-sans overflow-x-hidden">
      ...
      <AuthShowcase
        ...
        description="Plan, collaborate, and deliver projects faster with one unified workspace."
      />
      ...
      <div className="lg:col-span-5 flex flex-col justify-center px-8 sm:px-16 lg:px-20 py-8 relative z-10 border-l border-[#1C1C1C]">
        ...
        <div className="w-full max-w-sm space-y-6">
            ...
            <div className="flex items-center justify-between text-[11px]">
              <label className="flex items-center space-x-2 text-[#B5B5B5] cursor-pointer hover:text-white transition duration-150">
                <input
                  ...
                  className="rounded border-[#3C3C3C] bg-[#131313] text-brand-primary focus:ring-0 focus:ring-offset-0 h-3.5 w-3.5"
                />
          ...
          {/* Google Button */}
          <button onClick={handleGoogleSignIn} className="w-full auth-btn-google">
          ...
          <div className="text-center">
            <p className="text-[13px] text-[#B5B5B5] font-light">
              ...
              <Link to="/register-company" className="text-[#F3F3F3] hover:text-white font-semibold transition duration-150 ml-1">
                Create Account
              </Link>
            </p>
          </div>
