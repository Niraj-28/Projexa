  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center space-x-3">
        ...
        <div>
          <h1 className="text-2xl font-semibold text-white tracking-tight">Pending Leaves</h1>
          <p className="text-xs text-[#B5B5B5] mt-0.5 font-light font-sans">Review queue of all pending leave applications in this workspace.</p>
        </div>
      </div>
