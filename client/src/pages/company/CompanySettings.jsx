  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-xs text-[#64748B] mt-1 font-light">Configure organization policies, default working hours, and system parameters.</p>
      </div>

      <div className="bg-white border border-[#E2E8F0] rounded-2xl p-6 shadow-sm">
        <form onSubmit={handleSubmit} className="space-y-6 text-xs text-[#64748B] font-light">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="flex flex-col space-y-2">
              ...
              <input 
                ...
                className="bg-[#F4F5F9] border border-[#E2E8F0] text-xs text-[#0F172A] rounded-lg p-3 focus:outline-none focus:border-[#5A42EC] transition-all duration-200" 
                required
              />
            </div>
          ...
          <button 
            type="submit" 
            disabled={submitting}
            className="bg-[#5A42EC] hover:bg-[#4831D4] disabled:opacity-50 text-white px-6 py-2.5 rounded-lg text-xs font-semibold shadow transition-all duration-200 cursor-pointer flex items-center justify-center gap-2 mt-2"
          >
            {submitting ? (
              <>
