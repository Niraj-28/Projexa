  ...
  return (
    <div className="space-y-6 max-w-xl">
      <div className="flex items-center space-x-3">
        ...
        <div>
          <h1 className="text-2xl font-semibold text-white tracking-tight">Create Sprint Task</h1>
          <p className="text-xs text-[#B5B5B5] mt-0.5 font-light">Add new deliverable card to product backlog.</p>
        </div>
      </div>
